      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce"
        ...
        <tr>
          ...
          <tr>
              ...
              <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                  <select id="cat_id_1" name='cat_id' onchange="show_cat(1)">
                      ...
                      <?php if(is_array($cateinfoA)): foreach($cateinfoA as $key=>$v): ?><option value='<?php echo ($v["cat_id"]); ?>'><?php echo ($v["cat_name"]); ?></option><?php endforeach; endif; ?>
                  </select>
          ...
          <tr>
              ...
              <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
                  <select  id="cat_id_2" name = "ext_cat[]" onchange="show_cat(2)">
                      <option value='0'>-请选择-</option>
                  </select>
...
<script type="text/javascript">
    ...
    function show_goods_attr(){
        ...
        $.ajax({
            ...
            success:function(msg){
                var s = "";
                $.each(msg,function(n,v){
                    //唯一属性或多选属性,多选属性则生成一个下拉列表
                    if(v.attr_sel=='0'){
                        s += '<tr><td class="STYLE6" bgcolor="#FFFFFF"><div align="right"><span class="STYLE19">'+v.attr_name+'：</span></div></td>' +
                                '<td bgcolor="#FFFFFF"  class="STYLE6"><div align="left">';
                        ...
                        s += '<tr><td class="STYLE6" bgcolor="#FFFFFF"><div align="right"><span class="STYLE19">' +
                                '<span onclick="add_attr_item(this)">[+]</span><e>'+v.attr_name+'：</e></span></div></td><td bgcolor="#FFFFFF"  class="STYLE6"><div align="left">';
                        //设置下拉列表的显示内容
  ...
  {
      var dst_tr = $(obj).parent().parent().parent().parent();
      var fu_tr = dst_tr.clone();
      //把fu_tr内部的[+]号变为[-]号
