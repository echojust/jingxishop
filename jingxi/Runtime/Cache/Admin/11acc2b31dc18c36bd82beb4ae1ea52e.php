    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
          <img src="<?php echo C('SITE_URL'); echo (substr($v["goods_small_logo"],2)); ?>" alt="" width='120' /></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <img src="<?php echo C('AD_IMG_URL');?>del.gif" width="10" height="10" /> 删除 | 查看 | <img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" /><a href="<?php echo U('update',array('goods_id'=>$v['goods_id']));?>"> 编辑</a></div></td>
